...
async function getLatestData() {
    ...
    SELECT a.jarCode, a.name, a.jobs, d.numInsured, d.numInsured2, SUM(b.tax) as taxes 
    FROM companies a 
    ...
    LEFT JOIN 2021_data d ON d.jarCode = a.jarCode and d.month = c.month GROUP BY 1, 2, 3, 4, 5 ORDER BY taxes DESC;`))
}
